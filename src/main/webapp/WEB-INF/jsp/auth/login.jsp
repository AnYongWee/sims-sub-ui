                ...
                <div class="page-content-wrapper bg-transparent m-0">
                    <div class="height-10 w-100 shadow-lg px-4 bg-brand-gradient">
                        <div class="d-flex align-items-center container p-0">
                            ...
                            <a href="page_register.html" class="btn-link text-white ml-auto">계정 생성</a>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-5 col-xl-4 ml-auto">
                                    ...
                                    <div class="card p-4 rounded-plus bg-faded">
                                        <form id="js-login" novalidate="" action="/main.do">
                                            <div class="form-group">
                                                <label class="form-label" for="username">아이디</label>
                                                <input type="email" id="username" class="form-control form-control-lg" placeholder="아이디 또는 이메일" value="" required>
                                                <div class="invalid-feedback">No, you missed this one.</div>
                                                <div class="help-block"></div>
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label" for="password">비밀번호</label>
                                                <input type="password" id="password" class="form-control form-control-lg" placeholder="비밀번호" value="" required>
                                            ...
                                            <div class="row no-gutters">
                                                <div class="col-lg-6 pr-lg-1 my-2">
                                                    <button type="submit" class="btn btn-info btn-block btn-lg">구글 계정 <i class="fab fa-google"></i></button>
                                                </div>
                                                <div class="col-lg-6 pl-lg-1 my-2">
                                                    <button id="js-login-btn" type="submit" class="btn btn-danger btn-block btn-lg">로그인</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
